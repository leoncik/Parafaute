...
Une fois l'extension téléchargée, celle-ci sera active avec six paramètres par défaut :
...
5. La normalisation de l'orthographe selon la réforme de 1990 sera inactive.
6. L'extension ne sera active que sur les sites francophones (dont l'attribut HTML _lang_ est égal à "FR", variantes régionales comprises).
